    ...
    public SecurityFilterChain authorizationServerSecurityFilterChain(HttpSecurity http) throws Exception {
        ...
        authorizationServerConfigurer
                .clientAuthentication(auth->{
                    auth.errorResponseHandler(oauth2FailureHandler);
//                    auth.authenticationSuccessHandler(successHandler);
                })
                .tokenEndpoint(token->token.errorResponseHandler(oauth2FailureHandler))
                .oidc(oidc->{
...
//                .reuseRefreshTokens(false)
        ...
        return RegisteredClient
                ...
                .redirectUri("http://127.0.0.1:8001/login/oauth2/code/microService")
    ...
    private RegisteredClient createRegisteredClientAuthorizationCode(final String clientId) {
        ...
        return RegisteredClient
                ...
                .redirectUri("http://localhost:7000/login/oauth2/code/myClient")
                .redirectUri("http://127.0.0.1:7000/login/oauth2/code/myClient")
                .redirectUri("http://client.com.cn:7000/login/oauth2/code/myClient")
                .redirectUri("http://127.0.0.1:8000")
                .redirectUri("http://127.0.0.1:7000")
                .redirectUri("http://client.com.cn:7000")
                // 授权范围（当前客户端的授权范围）
                .scope("read")
                .scope("write")
                .scope("server_a")
